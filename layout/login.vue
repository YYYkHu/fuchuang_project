  ...
  <div class="modal">
   <div class="modal-container">
    <div class="signin">
      ...
      <p class="zhuce">Don't have an account? <button id="registerBtn" class="input-button">注册</button></p>
    </div>
    <div class="signup">
      <h1 class="modal-title">你好！</h1>
      <p class="modal-desc">Fanny pack hexagon food truck, street  kitsch.</p>
     <div class="input-block">
      <label for="email" class="input-label">Email</label>
      <input type="email" name="email" id="email" placeholder="Email">
     </div>
    ...
    <p class="zhuce">Don't have an account? <button id="loginBtn" class="input-button">登录</button></p>
  </div>
   ...
   <!-- 背景动效 -->
 <div class="blobs" role="progressbar">
...
@layer demo {
    ...
    .blobs > :nth-child(4) .blob {
        background-color: var(--blob-color-3);
        -webkit-animation-delay: calc(-0.6 * var(--blob-speed-scale));
  ...
  width: 100%; /* 或者设置为固定宽度，具体根据你的页面布局来决定 */
...
.modal.is-open .picture img {
  transform: scale(1);
}
.modal.is-open .signin {
